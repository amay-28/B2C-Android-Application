...
public class AddProductPresenter implements DialogPresenterInterface, Constant {
    private DialogViewInterface viewInterface;
    private Activity activity;

    public AddProductPresenter(DialogViewInterface viewInterface, Activity activity) {
