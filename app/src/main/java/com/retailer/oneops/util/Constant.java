...
public interface Constant {
    ...
    String VIRTUAL_INVENTORY = "VIRTUAL_INVENTORY";
    ...
    int OPEN_DIALOG_FOR_CATEGORY = 1;
    int UPLOAD_IMAGE = 1;
    int ADD_SERVICE = 2;
    int EDIT_SERVICE = 3;
    String IMAGE = "image";
    ...
    String SERVICE_DESCRIPTION = "service_description";
    ...
    String IS_TWO_DAY = "isTwoDay";
    String REFUND_POLICY="REFUND_POLICY";
